...
import type { InterfaceNodeData } from '@/lib/types/uml'

type InterfaceNodeType = Node<InterfaceNodeData, 'interface'>

function InterfaceNodeComponent({ data, selected }: NodeProps<InterfaceNodeType>) {
  return (
    <div
